...
<head>
    ...
    <link href="{{ asset('views/admin/app.css') }}" rel="stylesheet" type="text/css">
...
<body class="hold-transition sidebar-mini layout-fixed ">
    <div class="wrapper">
        ...
        <nav class="main-header navbar navbar-expand navbar-white navbar-light">
            ...
            <ul class="navbar-nav">
                ...
                @endcan --}}
                {{-- <li class="nav-item d-none d-sm-inline-block">
                    <a href="{{ route('locations.index') }}" class="nav-link">Location</a>
                </li> --}}
            </ul>
    ...
    <!-- REQUIRED SCRIPTS -->
    <script src="{{ asset('lte/path/to/demo.js') }}"></script>
    <!-- jQuery -->
